...
// Generated from OpenAPI doc version 1.0.11 and generator version 2.879.13
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.3.3",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.3.3 2.879.13 1.0.11 github.com/censys/censys-asset-graph-sdk-go",
