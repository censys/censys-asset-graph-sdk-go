...
value := components.CVSSComponentsUserInteractionUnknown

// Open enum: custom values can be created with a direct type cast
custom := components.CVSSComponentsUserInteraction("custom_value")
```
...
| Name                                    | Value                                   |
| --------------------------------------- | --------------------------------------- |
| `CVSSComponentsUserInteractionUnknown`  |                                         |
| `CVSSComponentsUserInteractionNone`     | none                                    |
| `CVSSComponentsUserInteractionRequired` | required                                |