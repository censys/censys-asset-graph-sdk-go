...
value := components.CVSSComponentsIntegrityUnknown

// Open enum: custom values can be created with a direct type cast
custom := components.CVSSComponentsIntegrity("custom_value")
```
...
| Name                             | Value                            |
| -------------------------------- | -------------------------------- |
| `CVSSComponentsIntegrityUnknown` |                                  |
| `CVSSComponentsIntegrityNone`    | none                             |
| `CVSSComponentsIntegrityLow`     | low                              |
| `CVSSComponentsIntegrityHigh`    | high                             |