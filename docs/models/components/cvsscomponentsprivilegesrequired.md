...
value := components.CVSSComponentsPrivilegesRequiredUnknown

// Open enum: custom values can be created with a direct type cast
custom := components.CVSSComponentsPrivilegesRequired("custom_value")
```
...
| Name                                      | Value                                     |
| ----------------------------------------- | ----------------------------------------- |
| `CVSSComponentsPrivilegesRequiredUnknown` |                                           |
| `CVSSComponentsPrivilegesRequiredNone`    | none                                      |
| `CVSSComponentsPrivilegesRequiredLow`     | low                                       |
| `CVSSComponentsPrivilegesRequiredHigh`    | high                                      |