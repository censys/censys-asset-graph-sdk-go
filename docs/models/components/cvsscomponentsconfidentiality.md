...
value := components.CVSSComponentsConfidentialityUnknown

// Open enum: custom values can be created with a direct type cast
custom := components.CVSSComponentsConfidentiality("custom_value")
```
...
| Name                                   | Value                                  |
| -------------------------------------- | -------------------------------------- |
| `CVSSComponentsConfidentialityUnknown` |                                        |
| `CVSSComponentsConfidentialityNone`    | none                                   |
| `CVSSComponentsConfidentialityLow`     | low                                    |
| `CVSSComponentsConfidentialityHigh`    | high                                   |