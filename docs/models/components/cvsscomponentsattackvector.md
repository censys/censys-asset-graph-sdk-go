...
value := components.CVSSComponentsAttackVectorUnknown

// Open enum: custom values can be created with a direct type cast
custom := components.CVSSComponentsAttackVector("custom_value")
```
...
| Name                                 | Value                                |
| ------------------------------------ | ------------------------------------ |
| `CVSSComponentsAttackVectorUnknown`  |                                      |
| `CVSSComponentsAttackVectorNetwork`  | network                              |
| `CVSSComponentsAttackVectorAdjacent` | adjacent                             |
| `CVSSComponentsAttackVectorLocal`    | local                                |
| `CVSSComponentsAttackVectorPhysical` | physical                             |