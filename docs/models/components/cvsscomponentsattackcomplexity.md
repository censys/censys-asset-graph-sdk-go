# CVSSComponentsAttackComplexity
...
value := components.CVSSComponentsAttackComplexityUnknown

// Open enum: custom values can be created with a direct type cast
custom := components.CVSSComponentsAttackComplexity("custom_value")
```
...
| Name                                    | Value                                   |
| --------------------------------------- | --------------------------------------- |
| `CVSSComponentsAttackComplexityUnknown` |                                         |
| `CVSSComponentsAttackComplexityLow`     | low                                     |
| `CVSSComponentsAttackComplexityHigh`    | high                                    |