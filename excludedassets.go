...
type ExcludedAssets struct {
	rootSDK          *SDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newExcludedAssets(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ExcludedAssets {
...
func (s *ExcludedAssets) ListExcludedAssets(ctx context.Context, graphID string, pageToken *string, pageSize *int, opts ...operations.Option) (*operations.ListExcludedAssetsResponse, error) {
	...
	res := &operations.ListExcludedAssetsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ListExcludedAssetsOutputBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListExcludedAssetsOutputBody = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
// CreateExcludedAsset - Create an excluded asset
...
func (s *ExcludedAssets) CreateExcludedAsset(ctx context.Context, graphID string, body components.AssetRefInput, opts ...operations.Option) (*operations.CreateExcludedAssetResponse, error) {
	...
	res := &operations.CreateExcludedAssetResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ExcludedAsset
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ExcludedAsset = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
// DeleteExcludedAsset - Delete an excluded asset
...
func (s *ExcludedAssets) DeleteExcludedAsset(ctx context.Context, graphID string, excludedAssetID string, opts ...operations.Option) (*operations.DeleteExcludedAssetResponse, error) {
	...
	res := &operations.DeleteExcludedAssetResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
