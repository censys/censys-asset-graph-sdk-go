...
func newShards(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Shards {
	return &Shards{
		rootSDK:          rootSDK,
...
func (s *Shards) ListShards(ctx context.Context, graphID string, executionID string, pageToken *string, pageSize *int, opts ...operations.Option) (*operations.ListShardsResponse, error) {
	request := operations.ListShardsRequest{
		GraphID:     graphID,
	...
	globals := operations.ListShardsGlobals{
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api/v1/asset-graphs/{graph_id}/executions/{execution_id}/shards", request, globals)
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ListShardsOutputBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListShardsOutputBody = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
