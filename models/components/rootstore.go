...
// RootStoreType - The certificate's type. Options include root, intermediate, or leaf.
type RootStoreType string

const (
	RootStoreTypeUnknown      RootStoreType = ""
	RootStoreTypeRoot         RootStoreType = "root"
	RootStoreTypeIntermediate RootStoreType = "intermediate"
	RootStoreTypeLeaf         RootStoreType = "leaf"
)

func (e RootStoreType) ToPointer() *RootStoreType {
	return &e
}

// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *RootStoreType) IsExact() bool {
	if e != nil {
		switch *e {
...
type RootStore struct {
	...
	Type *RootStoreType `json:"type,omitempty"`
}
...
func (r *RootStore) GetType() *RootStoreType {
	if r == nil {
		return nil
	}
	return r.Type
